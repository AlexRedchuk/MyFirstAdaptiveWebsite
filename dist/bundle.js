...
/* harmony import */ var _modules_multiRangeSlider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/multiRangeSlider */ "./js/modules/multiRangeSlider.js");
/* harmony import */ var _modules_calcTabs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/calcTabs */ "./js/modules/calcTabs.js");
/* harmony import */ var _modules_gallery__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/gallery */ "./js/modules/gallery.js");
/* harmony import */ var _modules_timer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/timer */ "./js/modules/timer.js");
/* harmony import */ var _modules_reviewSlider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/reviewSlider */ "./js/modules/reviewSlider.js");
/* harmony import */ var _modules_news__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/news */ "./js/modules/news.js");
/* harmony import */ var _modules_subInput__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/subInput */ "./js/modules/subInput.js");
/* harmony import */ var _modules_anchor__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/anchor */ "./js/modules/anchor.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_anchor__WEBPACK_IMPORTED_MODULE_8__.default)();
});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (calcTabs);
...
function gallery() {
  var galleryBox = document.querySelectorAll('.gallery_photo');
  galleryBox.forEach(function (box) {
...
function header() {
  var header = document.querySelector('.header_backdrop'),
  ...
  function scrollFunction() {
    ...
    blocks.forEach(function (block) {
      if (window.pageYOffset + 100 >= block.offsetTop) {
        clearActive();
        document.querySelector("[data-menu=\"".concat(block.getAttribute('id'), "\"]")).classList.add('active_header_item');
      }
    });
  }
  ...
  var burgerBtn = document.querySelector('.header_burger'),
...
/***/ "./js/modules/multiRangeSlider.js":
/*!****************************************!*\
  !*** ./js/modules/multiRangeSlider.js ***!
  \****************************************/
/*! namespace exports */
...
function multiRangeSlider() {
  ...
  function setLeftValue() {
    ...
    minPrice.textContent = "$".concat((percent * 120).toFixed(0));
  }
  ...
  function setRightValue() {
    ...
    maxPrice.textContent = "$".concat((percent * 120).toFixed(0));
  }
...
function news() {
  var newsBlocks = document.querySelectorAll('.news_card');
...
function reviewSlider(sliderSelector, itemsSelector, slideName) {
  ...
  var position = -380,
      ...
      posX2 = 0,
      posInitial = 0;
  items.style.transform = "translate(".concat(position, "px)");
  ...
  function removeAdptiveNav() {
    var nav = document.querySelectorAll('[data-slidernav]');
  ...
  function mediaAdaptation() {
    if (media1024.matches) {
      removeAdptiveNav();
      var navigatorContainer = document.querySelector('.review_slider_navigation');
      ...
      var adaptiveNavs = document.querySelectorAll('[data-slidernav]');
      changeNavs(adaptiveNavs);
      setActiveNavigation(2, adaptiveNavs);
    } else if (media767.matches) {
      var _navigatorContainer = document.querySelector('.review_slider_navigation');

      removeAdptiveNav();

      _navigatorContainer.insertAdjacentHTML('beforeend', "\n                    <div data-slidernav=\"3\" class=\"navigation_circle\"></div>\n                    <div data-slidernav=\"4\" class=\"navigation_circle\"></div>\n                    <div data-slidernav=\"5\" class=\"navigation_circle\"></div>\n                    <div data-slidernav=\"6\" class=\"navigation_circle\"></div>\n                    <div data-slidernav=\"7\" class=\"navigation_circle\"></div>\n                    <div data-slidernav=\"8\" class=\"navigation_circle\"></div>\n            ");

      var _adaptiveNavs = document.querySelectorAll('[data-slidernav]');

      changeNavs(_adaptiveNavs);
      setActiveNavigation(1, _adaptiveNavs);
...
function subInput() {
  ...
  subInput.addEventListener('focusout', function () {
    subInput.classList.remove('sub_input_focus');
  });
}

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (subInput);
...
function timer(selector, deadline) {
  ...
  function setTime() {
    var timerBox = document.querySelector(selector),
    ...
    var timeIntervalID = setInterval(changeClock, 1000);
    changeClock();

    function changeClock() {
      var time = getTimeRemain();
